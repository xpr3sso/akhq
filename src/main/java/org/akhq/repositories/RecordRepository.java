...
public class RecordRepository extends AbstractRepository {
    ...
    public List<RecordMetadata> produce(
        ...
        // Distinguish between single record produce, and multi-message
        if (multiMessage.booleanValue()) {
            // Split key-value pairs and produce them
            for (KeyValue<String, String> kvPair : splitMultiMessage(value, messageSeparator.get(), keyValueSeparator.get())) {
